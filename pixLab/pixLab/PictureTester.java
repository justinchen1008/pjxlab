...
public class PictureTester
{
  ...
  /** Method to test the the liquify method */
  public static void testLiquify(int maxHeight)
  {
    Picture beach = new Picture("images/beach.jpg");
    beach.explore();
    beach = beach.liquify(maxHeight);
    beach.explore();
  }
  ...
  /**Shifts the picture to the right in a sinusoidal manner
   * @param size	the amplitude of the sin function (how large the waves are)
   */
  public static void testWavy(int amplitude)
  {
    Picture beach = new Picture("images/gorge.jpg");
    beach.explore();
    beach = beach.wavy(amplitude);
    beach.explore();
  }
